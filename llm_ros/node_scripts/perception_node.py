...
class PerceptionNode(object):
    def __init__(self):
        ...
        self.sub_cmd = rospy.Subscriber("/llm_agent/perception/query", Query, self.callback, queue_size=1)
        self.pub_detection = rospy.Publisher("/llm_agent/perception/detection", Message, queue_size=1)
    ...
    def query_gd(self, obj_to_query):
        ...
        rospy.sleep(2.0)
        gd_answer = rospy.wait_for_message("/grounding_dino_node/output/class", ClassificationResult)
