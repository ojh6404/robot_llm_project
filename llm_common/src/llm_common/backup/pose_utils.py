...
class PoseChange(object):
    ...
    def look_with_head(
        self,
        head_pan_joint: float = 0.0,
        head_tilt_joint: float = -0.86,
        arm_lift_joint: float = 0.0,
    ):
            ...
            self.whole_body.move_to_joint_positions(
                {
                    ...
                    "head_pan_joint": 0.0,
                    "head_tilt_joint": 0.0,
                    "wrist_flex_joint": -1.5699986694517207,
                    "wrist_roll_joint": 0.0,
                }
            )
            self.whole_body.move_to_joint_positions({"arm_lift_joint": arm_lift_joint})
            self.whole_body.move_to_joint_positions(
                {"head_pan_joint": head_pan_joint, "head_tilt_joint": head_tilt_joint}
            )
        else:
            self.whole_body.move_to_joint_positions(
                {
                    ...
                    "arm_roll_joint": -1.5699999993825218,
                    "wrist_flex_joint": -1.5699986694517207,
                    "wrist_roll_joint": 0.0002087858536721221,
    ...
    def look_with_hand(
        ...
        ref_frame_id: str = "map",
        distance: float = 0.4,
    ):
        if target is None:  # default pose
            whole_body.move_to_joint_positions(
                {
                    "arm_flex_joint": -0.9299687544868802,
                    "arm_lift_joint": 0.0015562783630354406,
                    "arm_roll_joint": -0.11920613613947317,
                    "head_pan_joint": -5.855961609846361e-06,
                    "head_tilt_joint": -0.5000008260019606,
                    "wrist_flex_joint": -1.8336200039870336,
                    "wrist_roll_joint": 0.251613702398501,
                }
            )
    ...
    def look_hand_with_head(self):
        ...
        whole_body.move_to_joint_positions(
            {
                "arm_flex_joint": -1.1033087544868803,
                "arm_lift_joint": 0.00016368781302191718,
                "arm_roll_joint": 3.242328863860527,
                "head_pan_joint": 0.0,
                "head_tilt_joint": -0.6,
                "wrist_flex_joint": -1.6511140039870336,
                "wrist_roll_joint": -1.5523472976014987,
            }
        )
...
if __name__ == "__main__":
    ...
    settings._SETTINGS["trajectory"]["action_timeout"] = 1
    whole_body = robot.try_get("whole_body")
    settings._SETTINGS["trajectory"]["action_timeout"] = 30.0
